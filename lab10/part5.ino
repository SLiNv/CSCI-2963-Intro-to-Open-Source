...
//     lcd.print(message[1]);
//     lcd.print(':');
//     lcd.print(message.substring(2));
   } else {
//     lcd.clear();
     //lcd.print(message.substring(1,3));
     //lcd.print(':');
     //lcd.print(message.substring(3));
     hour = (message.substring(1,3)).toInt();
     minute =  (message.substring(3)).toInt();
     second = 0;
     pretime = 0;
     stop = false;
    }
